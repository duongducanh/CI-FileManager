...
class MY_Model extends CI_Model {
    ...
    /*Tuan Nguyen 1`.05.2015*/
    protected $user_id = "user_id";
    protected $parent_id = "parent_id";
    protected $is_trash = "is_trash";
    /**
    ...
    public function get_by_user_id($user_id) {
        return $this->get_by($this->user_id, $user_id);
    }

    /*Get all list trash*/
  
    public function get_all_list_trash($is_trash){
        $this->_database->where_in($this->is_trash, $is_trash);
        return $this->get_all();   
    }
    ...
    public function get_meny_by_user_id($user_id){
        $this->_database->where_in($this->user_id, $user_id);

        return $this->get_all();   
    }

    /**
     * Fetch an array of 1 based on an arbitrary WHERE call.
     */
